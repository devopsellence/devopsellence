...
class IndexPHPTemplateSmokeTest < Minitest::Test
  def test_template_contains_deployable_index_php_app
    ...
    Dir.mktmpdir("devopsellence-index-php-template-") do |dir|
      ...
      assert_includes dockerfile, "display_errors = Off"
      assert_includes dockerfile, "expose_php = Off"
      assert_includes dockerfile, "cgi.fix_pathinfo = 0"
      assert_includes dockerfile, "session.cookie_httponly = 1"
